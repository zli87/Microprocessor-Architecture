...
while(1):
    ...
    print("[info] perfect_oracle_perfect_trace_cache")
    os.system("make cleanrun SIM_FLAGS_EXTRA='--disambig=1,0,0 --perf=1,0,0,1 -t --fq=64 --cp=32 --al=256 --lsq=128 --iq=64 --iqnp=4 --fw=4 --dw=4 --iw=8 --rw=4 -e100000000'")
    os.system("mv stats* perfect_oracle_perfect_trace_cache_stats.txt")
    os.system("mv phase* perfect_oracle_perfect_trace_cache_phase.txt")
    ...
    print("[info] perfect_oracle_4_chkpts")
    os.system("make cleanrun SIM_FLAGS_EXTRA='--disambig=1,0,0 --perf=1,0,0,0 --fq=64 --cp=4 --al=256 --lsq=128 --iq=64 --iqnp=4 --fw=4 --dw=4 --iw=8 --rw=4 -e100000000'")
    os.system("mv stats* perfect_oracle_4_chkpts_stats.txt")
    os.system("mv phase* perfect_oracle_4_chkpts_phase.txt")
    print("[info] perfect_oracle_perfect_trace_cache_4_chkpts")
    os.system("make cleanrun SIM_FLAGS_EXTRA='--disambig=1,0,0 --perf=1,0,0,1 -t --fq=64 --cp=4 --al=256 --lsq=128 --iq=64 --iqnp=4 --fw=4 --dw=4 --iw=8 --rw=4 -e100000000'")
    os.system("mv stats* perfect_oracle_perfect_trace_cache_4_chkpts_stats.txt")
    os.system("mv phase* perfect_oracle_perfect_trace_cache_4_chkpts_phase.txt")
