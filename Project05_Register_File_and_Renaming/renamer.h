...
typedef struct {
		...
		bool completed;
		bool exception;
		bool load_viol; 	// load violation
		bool br_misp; 		// branch misprediction bit
		bool val_misp; 		// value misprediction bit
		bool load;
		bool store;
		bool branch;
		bool amo;
		bool csr;
		uint64_t PC;
}AL_EN; // one entry of active list

typedef struct {
	uint64_t *RMT_shdw;
	list_idx FL_head;
	uint64_t GBM;	// GBM "before" set branch's bit to 1
}BRCP_EN;	// branch checkpoint entry
...
private:
	...
	/////////////////////////////////////////////////////////////////////
	uint64_t MAX_BRANCH_NUM;
	uint64_t MT_SIZE;		// Size of both Map Table
	uint64_t LIST_SIZE;		// Size of both Active and Free List
	/////////////////////////////////////////////////////////////////////
	// Structure 1: Rename Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
	uint64_t *RMT; // each entry only need log2(phy_regs) bits.
	bool RMT_Find(uint64_t);
	/////////////////////////////////////////////////////////////////////
	// Structure 2: Architectural Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
	uint64_t *AMT; // each entry only need log2(phy_regs) bits.
	/////////////////////////////////////////////////////////////////////
...
//	uint64_t FL_tail;
	...
	uint64_t GBM;
	uint64_t getGBMnum();
	uint64_t getGBMnum(uint64_t);
	void print64bit(uint64_t, uint64_t, const char*);
	/////////////////////////////////////////////////////////////////////
	...
	// 3. checkpointed GBM
	/////////////////////////////////////////////////////////////////////
	BRCP_EN BRCP[64];	// maximum is 64 checkpoints
	/////////////////////////////////////////////////////////////////////
	// Private functions.
